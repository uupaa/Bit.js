...
//{@dev
    if (!global["BENCHMARK"]) {
        ...
        $valid($type(pattern, "UINT8Array|omit"), Bit_split, "pattern");
    }
//}@dev
...
//{@dev
    if (!global["BENCHMARK"]) {
        ...
        $valid($type(pattern, "UINT8Array|omit"), Bit_bin, "pattern");
    }
//}@dev
...
//{@dev
    if (!global["BENCHMARK"]) {
        ...
        $valid($type(pattern, "UINT8Array|omit"), Bit_dump, "pattern");
    }
//}@dev
