...
var Bit = {
    ...
    "split1":       Bit_split1,     // Bit.split1(u32:UINT32, bitPattern:UINT8Array|Uint8Array):Uint32Array
    "split2":       Bit_split2,     // Bit.split2(u32:UINT32, bitPattern:UINT8Array|Uint8Array):Uint32Array
    "split3":       Bit_split3,     // Bit.split3(u32:UINT32, bitPattern:UINT8Array|Uint8Array):Uint32Array
    "split4":       Bit_split4,     // Bit.split4(u32:UINT32, bitPattern:UINT8Array|Uint8Array):Uint32Array
    "popcnt":       Bit_popcnt,     // Bit.popcnt(u32:UINT32):UINT8
    "nlz":          Bit_nlz,        // Bit.nlz(u32:UINT32):UINT8
    "ntz":          Bit_ntz,        // Bit.ntz(u32:UINT32):UINT8
    "dump":         Bit_dump,       // Bit.dump(u32:UINT32 = 0, bitPattern:UINT8Array|Uint8Array, radix:UINT8 = 2):String
...
function Bit_split1(u32,          // @arg UINT32 - bits
                    bitPattern) { // @arg UINT8Array|Uint8Array - [width, ...]
                                  // @ret Uint32Array
    return _split(1, u32 & 0x000000ff, bitPattern);
}

function Bit_split2(u32,          // @arg UINT32 - bits
                    bitPattern) { // @arg UINT8Array|Uint8Array = null - [width, ...]
                                  // @ret Uint32Array
    return _split(2, u32 & 0x0000ffff, bitPattern);
}

function Bit_split3(u32,          // @arg UINT32 - bits
                    bitPattern) { // @arg UINT8Array|Uint8Array = null - [width, ...]
                                  // @ret Uint32Array
    return _split(3, u32 & 0x00ffffff, bitPattern);
}

function Bit_split4(u32,          // @arg UINT32 - bits
                    bitPattern) { // @arg UINT8Array|Uint8Array = null - [width, ...]
                                  // @ret Uint32Array
    return _split(4, (u32 & 0xffffffff) >>> 0, bitPattern);
}

function _split(bytes,        // @arg UINT8 - 1 - 4
...
//}@dev
    ...
    var r = _split(4, u32, bitPattern, bitLength);
    var result = [];

    for (var i = verbose ? 0 : 1, iz = r.length; i < iz; ++i) {
