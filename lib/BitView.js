...
BitView["prototype"] = Object.create(BitView, {
    ...
    // read bytes and split bits
    "rs1":          { "value": BitView_rs1      }, // BitView#rs1(bitPattern:UINT8Array|Uint8Array):UINT32Array
    "rs2":          { "value": BitView_rs2      }, // BitView#rs2(bitPattern:UINT8Array|Uint8Array):UINT32Array
    "rs3":          { "value": BitView_rs3      }, // BitView#rs3(bitPattern:UINT8Array|Uint8Array):UINT32Array
    "rs4":          { "value": BitView_rs4      }, // BitView#rs4(bitPattern:UINT8Array|Uint8Array):UINT32Array
    "length": {
...
function BitView_rs1(bitPattern) { // @arg UINT8Array|Uint8Array
                                   // @ret UINT32Array - [UINT32, ...]
    return Bit["split1"](this["r1"](), bitPattern);
}

function BitView_rs2(bitPattern) { // @arg UINT8Array|Uint8Array
                                   // @ret UINT32Array - [UINT32, ...]
    return Bit["split2"](this["r2"](), bitPattern);
}

function BitView_rs3(bitPattern) { // @arg UINT8Array|Uint8Array
                                   // @ret UINT32Array - [UINT32, ...]
    return Bit["split3"](this["r3"](), bitPattern);
}

function BitView_rs4(bitPattern) { // @arg UINT8Array|Uint8Array
                                   // @ret UINT32Array - [UINT32, ...]
