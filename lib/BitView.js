...
})("BitView", function moduleClosure(global, WebModule, VERIFY /*, VERBOSE */) {
"use strict";
...
BitView["prototype"] = Object.create(BitView, {
    ...
    "u":            { "value": BitView_u                }, // BitView#u(bits:UINT8):UINT32
    "nu":           { "value": BitView_nu               }, // BitView#nu(bits:UINT8):UINT32
    "ug":           { "value": BitView_ug               }, // BitView#ug():UINT32
    "sg":           { "value": BitView_sg               }, // BitView#sg():INT32
    "byteAlign":    { "value": BitView_byteAlign        }, // BitView#byteAlign():void
    "byteAligned":  { "get":   BitView_getByteAligned   }, // BitView#byteAligned:Boolean
    "remainBits":   { "get":   BitView_getRemainBits    }, // BitView#remainBits:UINT32
    "EOS":          { "get":   BitView_getEOS           }, // BitView#EOS:Boolean
...
// --- implements ------------------------------------------
function BitView_u(bits) { // @arg UINT8 - read bit(s), 1 - 32
                           // @ret UINT32
//{@dev
    if (VERIFY) {
        $valid($type(bits, "UINT8"), BitView_u, "bits");
    }
//}@dev
...
function BitView_nu(bits) { // @arg UINT8 - read bit(s), 1 - 32
                            // @ret UINT32
//{@dev
    if (VERIFY) {
        $valid($type(bits, "UINT8"), BitView_nu, "bits");
    }
//}@dev
...
function BitView_ug() { // @ret UINT32 - unsigned value
...
function BitView_sg() { // @ret INT32 - signed value
...
function BitView_getByteAligned() { // @arg Boolean
    return this._view.bitCursor === 7;
}

function BitView_getRemainBits() { // @ret UINT32
    if (this["EOS"]) {
        return 0;
    }
    var remainBytes = this._view.source.length - this._view.cursor - 1;

    return remainBytes * 8 + this._view.bitCursor + 1;
}

function BitView_getEOS() { // @ret Boolean - true is End Of Source
